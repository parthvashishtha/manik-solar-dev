  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.desc1}>
        {!english &&
          `ग्रामीण इलाकों में बिजली की कमी एक बड़ी समस्या है। रेज़ का उद्देश्य है कि हर घर को ऊर्जा की सुविधा मिले और वे भी बिजली के फायदे उठा सकें। हम सौर ऊर्जा के माध्यम से यह सुनिश्चित करते हैं कि गांवों में रहने वाले लोगों को निरंतर और विश्वसनीय बिजली मिले`}
        {english &&
      ...
      <div className={styles.row1}>
        <div className={styles.col1}>
          {!english &&
            "रेज़ के साथ, हम लगातार ऊर्जा के क्षेत्र में नई ऊंचाइयों को छू रहे हैं और ग्रामीण क्षेत्रों को ऊर्जा आत्मनिर्भर बनाने में योगदान दे रहे हैं।"}
          {english &&
      ...
      <div className={styles.row2}>
        <div className={styles.col21}>
          ...
          <br />
          {!english &&
            "रेज़ का मिशन है कि हम ग्रामीण भारत को स्वच्छ, सस्ती और सुलभ सौर ऊर्जा प्रदान करके ऊर्जा आत्मनिर्भर बनाएं। हमारा उद्देश्य न केवल ऊर्जा की समस्याओं को हल करना है, बल्कि पर्यावरण को संरक्षित रखना और सामाजिक विकास में योगदान देना भी है।"}
          {english &&
      ...
      <div className={styles.row3}>
        <div className={styles.col31}>
          ...
          <div className={styles.qdesc1}>
            {!english &&
              "रेज़ उच्च गुणवत्ता वाले सोलर पैनल प्रदान करता है जो ग्रामीण क्षेत्रों के लिए विशेष रूप से डिजाइन किए गए हैं। 🌞🏆"}
            {english &&
      ...
      <div className={styles.row4}>
        <div className={styles.col41}>
          ...
          <div className={styles.idesc}>
            {!english &&
              `रेज़ का लक्ष्य है कि हम अपने प्रयासों के माध्यम से ग्रामीण भारत को ऊर्जा आत्मनिर्भर बनाएं। हमारी प्रतिबद्धता है कि हम अपने ग्राहकों को सर्वोत्तम सेवा और उत्पाद प्रदान करें, जिससे उनकी ऊर्जा जरूरतें पूरी हो सकें और वे भी आधुनिक जीवन के सभी लाभ उठा सकें।`}
            {english &&
          ...
          <div className={styles.idesc}>
            {!english &&
              "रेज़ के साथ, हम एक उज्जवल और स्थायी भविष्य की ओर कदम बढ़ा रहे हैं, जहां हर गांव ऊर्जा आत्मनिर्भर हो और स्वच्छ ऊर्जा का लाभ उठा सके। 🌟🌿"}
            {english &&
