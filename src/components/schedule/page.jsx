  ...
  return (
    <div className={styles.container}>
      <div className={styles.head}>
        {!english && `आज ही हमारे साथ मुफ़्त सलाह के लिए समय`}
        {english && `Schedule a free consultation with`}
        <br /> {!english && `निर्धारित करें!`}
        {english && `us today!`} 📞✨
      </div>
      ...
      <div className={styles.section2}>
        <div className={styles.card}>
          ...
          <div className={styles.cardDesc}>
            {!english &&
              `रेज़ का मुख्य फोकस ग्रामीण इलाकों में सौर ऊर्जा का प्रसार करना है, जिससे उन क्षेत्रों को बिजली की सुविधा मिल सके जहाँ यह पहले संभव नहीं था। 🌾🏡`}
            {english &&
      ...
      <div className={styles.benefits2}>
        ...
        <div className={styles.ben1}>
          ...
          <div className={styles.bdesc}>
            {!english &&
              `हमारी सहायता टीम हमेशा आपकी सेवा में तैयार है, जिससे आप कभी भी किसी भी समस्या का समाधान पा सकते हैं।`}
            {english &&
      ...
      <div className={styles.head}>
        {!english &&
          `“घर में सोलर पैनल इंस्टॉल करें और पैसा बचाएं, बिजली चोरी नहीं, सौर ऊर्जा सही मायने में मेहनत का फल ह`}
        {english &&
      ...
      <div className={styles.pdesc}>
        {!english &&
          `रेज़ में, हम विभिन्न क्षेत्रों में सोलर पैनल इंस्टॉलेशन के सफल प्रोजेक्ट्स की एक विस्तृत श्रृंखला पर गर्व करते हैं। हमारे पोर्टफोलियो में शामिल हैं`}
        {english &&
